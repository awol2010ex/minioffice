...
insert into t_biz_menu (id, menu_index, menu_name, menu_url, pid) values ('1068a7be0004004f407014004f407790000', 2, '用户管理', '/views/user/userList.jsp', null);
insert into t_biz_menu (id, menu_index, menu_name, menu_url, pid) values ('1068a7be000400a8aff01400a8aff4b0000', 1, '我的正在运行流程', '/views/process/myProcessList.jsp', '1068a7be0163fa8ce95013fa8cf93bc0001');
insert into t_biz_menu (id, menu_index, menu_name, menu_url, pid) values ('1068a7be000400a988201400a9882080000', 2, '流程监控', '/views/process/allProcessList.jsp', '1068a7be0163fa8ce95013fa8cf93bc0001');
